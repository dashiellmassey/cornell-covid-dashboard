...
green2 <- c(date('2020-09-15'), date(max(covid$dates)))
...
plot_base <- function(x1, x2, y1, y2) {
  ggplot(data = NULL) +
    ...
    geom_rect(aes(xmin = green2[1]-0.5, xmax = x2,
                  ymin = y1, ymax = y2,
                  text = 'Threat Level Green: 9/16-present'),
              fill = threat_color_green) +
