...
yellow2 <- c(date('2020-11-12'), date(max(covid$dates)))
...
plot_base <- function(x1, x2, y1, y2) {
  ggplot(data = NULL) +
    ...
    geom_rect(aes(xmin = green2[1]-0.5, xmax = green2[2] + 0.5,
              ...
              fill = threat_color_green) +
    geom_rect(aes(xmin = yellow2[1]-0.5, xmax = x2,
                  ymin = y1, ymax = y2,
                  text = 'Threat Level Yellow: 11/13-present'),
              fill = threat_color_yellow) +
