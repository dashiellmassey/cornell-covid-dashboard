...
yellow4 <- c(date('2021-03-18'), date(max(covid$dates)))
...
plot_base <- function(x1, x2, y1, y2) {
  ggplot(data = NULL) +
    ...
    geom_rect(aes(xmin = green4[1]-0.5, xmax = green4[2] + 0.5,
              ...
              fill = threat_color_green) +
    geom_rect(aes(xmin = yellow4[1]-0.5, xmax = x2,
                  ymin = y1, ymax = y2,
                  text = 'Threat Level Yellow: 03/19-present'),
              fill = threat_color_yellow) +
